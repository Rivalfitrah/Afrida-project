<?php
require 'config/bahan_makanan.php';
?>
      ...
      <div class="layout-page">
        ...
        <div class="content-wrapper">
          <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Bahan /</span> Bahan Makanan</h4>
            <hr class="my-5" />
            ...
            <div class="modal-container d-flex justify-content-between align-items-center">
              ...
              <form method="POST" action="" class="search-container d-flex">
                <input type="text" name="search" class="search-input" placeholder="Search for products..." required autoc autocomplete="off">
            ...
            <div class="card">
              <h5 class="card-header">Daftar Produk bahan makanan</h5>
              <div class="table-responsive text-nowrap">
                <table class="table table-dark">
                  ...
                  <tbody id="item-table" class="table-border-bottom-0">
                    <?php
                    $ambildata = mysqli_query($conn, "select * from bahan_makanan");
