      ...
      <div class="layout-page">
        ...
        <div class="content-wrapper">
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Keuangan /</span> Pemasukkan</h4>

            <hr class="my-5" />

            <div class="container">
              <h4>Tabel Pemasukkan Toko</h4>
              <?php
              $total_pemasukan = 0;
              $sum_result = mysqli_query($conn, "SELECT SUM(pemasukan) AS total FROM pemasukan");
              if ($sum_row = mysqli_fetch_assoc($sum_result)) {
                $total_pemasukan = $sum_row['total'];
              }
              ?>
              <h4>Total Pemasukkan: Rp<?= number_format($total_pemasukan, 2, ',', '.'); ?></h4>
              <table class="table table-dark">
                    ...
                    <div class="modal-content">
                      ...
                      <form id="beritaForm" method="post" enctype="multipart/form-data">
                        <div class="modal-body">
                          ...
                          <br>
                          <input type="text" name="pemasukan" placeholder="pemasukan" class="form-control" autocomplete="off">
                          <br>
                ...
                <tbody id="item-table" class="table-border-bottom-0">
                  <?php
                  $ambildata = mysqli_query($conn, "select * from pemasukan");
                        ...
                        <div class="modal-content">
                          ...
                          <form id="beritaForm" method="post" enctype="multipart/form-data">
                            <div class="modal-body">
                              ...
                              <br>
                              <input type="text" name="pemasukan" value="<?= $pemasukan; ?>" placeholder="pemasukan" class="form-control" autocomplete="off">
                              <br>
