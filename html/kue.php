        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Bahan /</span> Bahan Kue</h4>
    ...
    <button type="button" class="btn btn-primary mt-3" data-bs-toggle="modal" data-bs-target="#exampleModal">
        Tambah
          ...
          <button type="submit" class="search-button">Search</button>
              ...
              <div class="card">
                <h5 class="card-header">Daftar Produk Bahan Kue</h5>
                <div class="table-responsive text-nowrap">
                  <table class="table table-dark">
                    ...
                    <tbody id="item-table" class="table-border-bottom-0">
                      <?php
                        $ambildata = mysqli_query($conn, "select * from bahan_kue");
